...
#[inline(never)]
pub extern "C" fn syscall(nb: usize, arg0: usize, arg1: usize, arg2: usize, arg3: usize, arg4: usize) -> usize {
    let res;
    unsafe {
        asm!(
            "int 80h",
...
pub unsafe fn write(file_descriptor: usize, buffer: *const usize, count: usize) -> usize {
    let response;
    asm!(
        "int 80h",
